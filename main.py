...
@app.get('/sort')
def sortby_patients( sort_by : str = Query( description='Sort on the basis of height, weight and bmi')
    ...
    if order not in ['asc' , 'desc']:
        raise HTTPException(status_code=400, details='Invalid order selection')
